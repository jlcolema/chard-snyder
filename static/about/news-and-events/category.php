	...
	<main id="content" role="main">
		...
		<div class="wrap">
			...
			<div class="main">
				...
				<h1>News &amp; Events by Category</h1>

				<div class="news-and-events-paginated-listing">
						...
						<ul>
							...
							<li>
								...
								<h2>
									...
									<a href="<?php echo BASE_URL; ?>about/news-and-events/entry.php">Title of the News or Event Post will Display Here</a>

								</h2>

								<time datetime="">Oct 19, 2015</time>

								<div class="item-summary">

									<p>A short description will display here and a user will click to see full reply is nist, ut parchil laccusantem fugit es inimusam acia vello maximus. Atibus ad quam, quo idus, sit que nus ipsapidusda vid que labore vent. Namentiam et volorrovid quia culluptatur aut aut est quiate pedicabo.</p>

								</div>

								<div class="more">

									<a href="<?php echo BASE_URL; ?>about/news-and-events/entry.php">
