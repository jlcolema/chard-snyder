	...
	<main id="content" role="main">
		...
		<div class="wrap">
			...
			<div class="main">
				...
				<h1>COBRA Information &amp; Resources</h1>
							...
							<li class="current">
								...
								<ul class="submenu">
									...
									<li>
										...
										<a href="<?php echo BASE_URL; ?>benefits/cobra-and-billing/cobra-information-and-resources.php" class="active">COBRA Information &amp; Resources</a>
