	...
	<main id="content" role="main">
		...
		<div class="wrap">
			...
			<div class="main">
					...
					<form>
						...
						<ul>
							...
							<li>
								...
								<label>Search our Videos</label>

								<input type="text" placeholder="Search Our Videos" />
				...
				<div class="videos-paginated-listing">
						...
						<ul>
							...
							<li>
								...
								<h2>
									...
									<a href="<?php echo BASE_URL; ?>support-center/videos/entry.php">This is the title of a video that will continue to multiple lines as needed. Users can click the title to see the full video.</a>

								</h2>

								<div class="item-summary">

									<p>Summary of video will display here and a user will click to see full reply is nist, ut parchil laccusantem fugit es inimusam acia vello maximus. Atibus ad quam, quo idus, sit que nus ipsapidusda vid que labore vent. Namentiam et volorrovid quia culluptatur aut aut est quiate pedicabo.</p>

								</div>

								<div class="more">

									<a href="<?php echo BASE_URL; ?>support-center/videos/entry.php">
					...
					<div class="">
						...
						<ul>
							...
							<li class="current">
								...
								<a href="<?php echo BASE_URL; ?>support-center/videos/category.php" class="active">HSA</a>
